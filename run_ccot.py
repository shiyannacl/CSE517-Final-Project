...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        ...
        # openai/gsm8k exposes multiple configs and now requires one explicitly.
        # Default to "main" to keep existing training scripts working.
        if self.dataset_name == "openai/gsm8k" and self.dataset_config_name is None:
            self.dataset_config_name = "main"
        ...
        if self.dataset_name is None and self.train_file is None and self.validation_file is None:
            ...
            if self.test_file is not None:
                ...
                assert extension in ["csv", "json", "jsonl", "txt"], "`test_file` should be a csv, a json/jsonl or a txt file."
